...
public class SecurityConfiguration {
    ...
    @Bean
    public AuthenticationManager authManager(UserDetailsService applicationUserDetailsService) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/decks/**").permitAll();
                    auth.requestMatchers(HttpMethod.POST, "/decks/**").authenticated();
